...
const ViewJobs = () => {
    ...
    return (
        <div className="p-5">
            <h1 className="text-2xl mb-5 text-[#FC5F0D] text-center">Explore Opportunities</h1>
                ...
                {jobs.map((job, index) => (
                    <div key={index} className="dashboard-box p-9 h-40 pt-3 flex justify-between items-center shadow-md">
                        ...
                        <div className="flex items-center">
                            ...
                            <Link to={`/jobdescription/${job._id}`} className="solid-button p-3 rounded-md mt-[1.25rem]">View Details</Link>
                        </div>
                    </div>
                ))}
            </div>
